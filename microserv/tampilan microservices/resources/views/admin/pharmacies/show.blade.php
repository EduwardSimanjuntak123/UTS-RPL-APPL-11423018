            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 mt-4">
                        <a href="{{ route('admin.pharmacies.edit', 1) }}" class="btn btn-warning">Edit</a>
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal">Delete</button>
                        <a href="{{ route('admin.pharmacies') }}" class="btn btn-outline-secondary">Back to List</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteModalLabel">Delete Pharmacy</h5>
            ...
            <div class="modal-footer">
                ...
                <form method="POST" action="{{ route('admin.pharmacies.destroy', 1) }}" style="display: inline;">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-danger">Delete Pharmacy</button>
                </form>
            </div>
        </div>
    </div>
