...
<div class="row">
    <div class="col-md-4">
        <div class="card text-center">
            <div class="card-body">
                ...
                <p class="text-muted">Dr. {{ auth()->user()->specialty ?? 'Medical Doctor' }}</p>
                <div class="mt-4">
                    <p>
                        <strong>License Number</strong><br>
                        <span class="text-muted">{{ auth()->user()->license_number ?? 'N/A' }}</span>
                    </p>
                    <p>
                ...
                <div class="mt-4">
                    <a href="{{ route('doctor.profile.edit') }}" class="btn btn-primary btn-sm w-100">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <strong>Appointments Completed</strong><br>
                    <span class="text-muted">{{ $completedAppointments ?? 0 }}</span>
                </div>
                <div class="mb-3">
                    <strong>Prescriptions Issued</strong><br>
                    <span class="text-muted">{{ $prescriptionsIssued ?? 0 }}</span>
                </div>
                <div>
                    <strong>Medical Records Created</strong><br>
                    <span class="text-muted">{{ $recordsCreated ?? 0 }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <i class="bi bi-pencil-square"></i> Professional Information
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('doctor.profile.update') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('specialty') is-invalid @enderror" id="specialty" name="specialty" value="{{ old('specialty', auth()->user()->specialty) }}" required>
                            @error('specialty')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('license_number') is-invalid @enderror" id="license_number" name="license_number" value="{{ old('license_number', auth()->user()->license_number) }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" disabled>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                {{-- Password update form disabled - to be implemented via API --}}
                {{-- 
