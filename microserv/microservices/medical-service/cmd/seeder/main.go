...
import (
	...
	"log"
	"os"
	"github.com/meditrack/medical-service/internal/seeders"
...
func main() {
	...
	log.Println("✅ Connected to medical-service database")
	...
	fmt.Println("\n✅ Medical Service seeding completed successfully!")
}
