...
import (
	...
	"log"
	"os"
	"github.com/meditrack/pharmacy-service/internal/seeders"
...
func main() {
	...
	log.Println("✅ Connected to pharmacy-service database")
	...
	fmt.Println("\n✅ Pharmacy Service seeding completed successfully!")
}
