...
import (
	...
	"log"
	"os"
	"github.com/meditrack/payment-service/internal/seeders"
...
func main() {
	...
	log.Println("✅ Connected to payment-service database")
	...
	fmt.Println("\n✅ Payment Service seeding completed successfully!")
}
