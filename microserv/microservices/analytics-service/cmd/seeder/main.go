...
import (
	...
	"log"
	"os"
	"github.com/meditrack/analytics-service/internal/seeders"
...
func main() {
	...
	log.Println("✅ Connected to analytics-service database")
	...
	fmt.Println("\n✅ Analytics Service seeding completed successfully!")
}
